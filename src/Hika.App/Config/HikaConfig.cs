...
public sealed class SpeechConfig
{
    ...
    /// Русский язык: small — минимум для сносного качества, largev3turbo — заметно лучше.
    /// </summary>
...
{
    /// <summary>Основные слова пробуждения. Варианты произношения добавляются автоматически.</summary>
    public List<string> Words { get; set; } = new() { "хика", "ави" };
    ...
    /// <summary>Насколько прощать расхождение, 0..1. Больше — срабатывает чаще, но и ложно тоже.</summary>
    public double Tolerance { get; set; } = 0.34;
