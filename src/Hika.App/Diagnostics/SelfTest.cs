...
public static class SelfTest
{
    public static async Task<int> RunAsync(string[] args)
    {
        ...
        Line();
        Line("Про скорость сюда больше можно не ходить: программа замеряет себя");
        Line("сама, пока вы ей пользуетесь. Настройки → «Что происходит» —");
        Line("там видно, из чего сложилось ожидание, и есть кнопка, которая");
        Line("исправляет то, что в нём длиннее всего.");
