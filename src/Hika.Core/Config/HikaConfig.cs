...
public sealed class SpeechConfig
{
    ...
    /// <summary>
    /// Сколько речи накопить перед ранней проверкой, мс.
    ///
    /// Ровно та задержка, через которую загорается кайма, — и было её
    /// почти вдвое больше нужного. Имя произносится за три четверти секунды
    /// вместе с предзаписью, так что шестисот миллисекунд хватает,
    /// а свечение появляется, пока человек ещё договаривает команду.
    /// </summary>
    public int ProbeAfterMs { get; set; } = 600;
