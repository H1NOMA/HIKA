...
public static class Conversation
{
    ...
    private static readonly string[][] StrongOpeners =
    {
        ...
        // «Что такое», «кто такой» и «как ...» сюда намеренно не входят:
        // это обороты поиска, и человек по ним ждёт выдачу в браузере,
        // а не устный ответ. Разбор команд превращает их в поиск раньше,
        // чем дело доходит до разговора.
